...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        if (StringUtils.isAnyBlank(userAccount, userPassword)) {
            throw new BusinessException(ErrorCode.NULL_ERROR,"账户不可为空！");
        }
        if (StringUtils.isAnyBlank( userPassword)) {
            throw new BusinessException(ErrorCode.NULL_ERROR,"密码不可为空！");
        }
        if (StringUtils.isAnyBlank(checkPassword)) {
            throw new BusinessException(ErrorCode.NULL_ERROR,"确认密码不可为空！");
        }
        if (StringUtils.isAnyBlank(planetCode)) {
            throw new BusinessException(ErrorCode.NULL_ERROR,"星球号码不可为空！");
        }
